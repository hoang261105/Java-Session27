...
import validate.ClassRoomValidator;
...
public class ClassRoom implements IApp{
    ...
    public void inputData(Scanner sc) {
        this.classroomName = inputClassroomName(sc);

        this.courseId = SelectAttribute.selectCourseById(sc);

        this.createdAt = Validator.validateInputLocalDate(sc, "Nhập ngày tạo:");

        this.status = Validator.validateEnumInput(sc, "Nhập trạng thái lớp: ", Status.class);
    }

    private String inputClassroomName(Scanner sc) {
        String classroomName = Validator.validateInputString(sc, "Nhập lớp học: ", new StringRule(15, 50));
        return ClassRoomValidator.validateExistClassroom(sc, classroomName);
    }
