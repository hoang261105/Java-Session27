        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    UniversityManager.courseList.get(indexUpdate).setCourseName(CourseValidator.validateExist(sc, courseName, "courseName"));
                    System.out.println("Cập nhật tên khóa học thành công");
                    break;
                case 2:
                    boolean newStatus = Validator.validateInputBoolean(sc, "Nhập trạng thái của khóa học:");
