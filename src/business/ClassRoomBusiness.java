...
public class ClassRoomBusiness {
    ...
    public void updateClassRoom(Scanner sc) {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    String newClassRoomName = Validator.validateInputString(sc, "Nhập lớp học mới: ", new StringRule(15, 50));
                    classRoom.setClassroomName(ClassRoomValidator.validateExistClassroom(sc, newClassRoomName));
                    System.out.println("Cập nhật tên lớp học thành công!");
                    break;
                case 2:
                    String courseId = SelectAttribute.selectCourseById(sc);
                    classRoom.setCourseId(courseId);
                    System.out.println("Cập nhật id khóa học thành công!");
                    break;
                case 3:
                    LocalDate newCreatedAt = Validator.validateInputLocalDate(sc, "Nhập ngày tạo mới:");
